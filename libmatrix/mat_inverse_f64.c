  ...
  mat_instance_f64 * pDst)
{
  ...
  double *pInT1, *pInT2;                      /* Temporary input data matrix pointer */
  double *pOutT1, *pOutT2;                    /* Temporary output data matrix pointer */
  double *pPivotRowIn, *pPRT_in, *pPivotRowDst, *pPRT_pDst;  /* Temporary input and output data matrix pointer */
  uint32_t numRows = pSrc->rows;              /* Number of rows in the matrix  */
  uint32_t numCols = pSrc->cols;              /* Number of Cols in the matrix  */

  double Xchg, in = 0.0;                     /* Temporary input values  */
